        ...
        <div style={{ padding: '1rem', background: '#f5f5f5', color: '#111', minHeight: '100vh', fontFamily: 'sans-serif' }}>
            ...
            {state.activeQuestion ? (
                <div style={{ background: '#e3f2fd', border: '2px solid #2196f3', borderRadius: '10px', padding: '1rem' }}>
                    <h2 style={{ fontSize: '1.4rem', color: '#1976d2', margin: '0 0 1rem 0', textAlign: 'center' }}>Вопрос за {state.categories[state.activeQuestion.cIndex].questions[state.activeQuestion.qIndex].price}</h2>
